...
const Home = () => {
  return (
    <main className="mt-14">
      ...
      <section
        className={twMerge(
          "mb-24 pt-24 relative overflow-hidden",
          styles.dogBg
        )}
      >
      ...
      <section className="flex flex-col items-center mb-24">
        <div className="ph-container">
          <h2 className="ph-heading--three mb-6">
            Find the perfect pet for you
          </h2>

          <p className="ph-body--small max-w-[800px] mb-12 text-center">
            Only a limited number of each minymon will be released. You can see
            which minymons are up for adoption now, or contact our team to
